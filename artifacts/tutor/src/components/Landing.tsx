        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-6 py-14 sm:py-16">
          ...
          <div className="grid md:grid-cols-3 gap-5 items-stretch">
            ...
            <div className="border border-primary bg-primary text-primary-foreground p-7 flex flex-col shadow-lg">
              ...
              <Button onClick={() => openContact("payment")} className="mt-6 bg-accent text-accent-foreground hover:bg-accent/90">Unlock all 17 topics</Button>
            </div>
            {/* Annual */}
            <div className="border border-border bg-card p-7 flex flex-col">
              ...
              <Button onClick={() => openContact("payment")} variant="secondary" className="mt-6">Get the annual bundle</Button>
            </div>
          </div>
