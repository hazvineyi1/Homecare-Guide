    ...
    check: [
      {
        ...
        answer: 1,
        why: "The book states people recover better at home, stay in control and keep their independence, which is why home care is preferred.",
      },
      {
        ...
        answer: 2,
        why: "The book lists unopened mail, poor hygiene and forgetfulness among the warning signs that a person may need care.",
      },
    ],
  },
  2: {
    ...
    check: [
      {
        ...
        answer: 1,
        why: "The book lists determining the level and hours of care needed and exploring options among the steps to prepare.",
      },
      {
        ...
        answer: 2,
        why: "The book states that preparedness reduces caregiver burden and improves care quality.",
      },
    ],
  },
  4: {
    ...
    check: [
      {
        ...
        answer: 1,
        why: "The book explains that doing the same basic activity at the same time daily builds security and independence.",
      },
      {
        ...
        answer: 2,
        why: "The book says the medication system should record the prescriber, purpose, dosage, frequency and pharmacy, and remove expired drugs.",
      },
    ],
  },
  5: {
    ...
    check: [
      {
        ...
        answer: 0,
        why: "The book lists keen observation as a key quality precisely because patients may hide problems.",
      },
      {
        ...
        answer: 1,
        why: "The book says caregivers build knowledge by talking to health professionals, doing research and keeping an information folder.",
      },
    ],
  },
  6: {
    ...
    check: [
      {
        ...
        answer: 1,
        why: "The book states the plan contains needs and problems, patient views, available resources, goals and who provides services.",
      },
      {
        ...
        answer: 1,
        why: "The book advises distributing the plan, appointing a follow-up coordinator and using an online communication platform.",
      },
    ],
  },
  7: {
    ...
    check: [
      {
        ...
        answer: 1,
        why: "The book lists confusion, rapid breathing and a temperature of 37.8C or more among the symptoms of a possible infection.",
      },
      {
        ...
        answer: 2,
        why: "The book defines sepsis as the body's overreaction to an infection that develops quickly and is life-threatening.",
      },
    ],
  },
  8: {
    ...
    check: [
      {
        ...
        answer: 1,
        why: "The book states that for women perineal care is done front to back to prevent infection.",
      },
      {
        ...
        answer: 1,
        why: "The book advises repositioning every two hours and protecting the skin from urine and stool.",
      },
    ],
  },
  9: {
    ...
    check: [
      {
        ...
        answer: 1,
        why: "The book says to see a doctor for diarrhoea if there is fever, vomiting, blood, or it continues for five days.",
      },
      {
        ...
        answer: 1,
        why: "The book recommends a constant predictable environment, routines at a regular place and time, and clear communication for confusion.",
      },
    ],
  },
  10: {
    ...
    check: [
      {
        ...
        answer: 1,
        why: "The book defines palliative care as total care that improves quality of life and controls pain and other symptoms.",
      },
      {
        ...
        answer: 1,
        why: "The book stresses that honesty is very important and that age-appropriate language should be used with children.",
      },
    ],
  },
  11: {
    ...
    check: [
      {
        ...
        answer: 1,
        why: "The book lists sleep problems, irritability, social withdrawal, appetite change, tiredness and crying easily as signs of role strain.",
      },
      {
        ...
        answer: 1,
        why: "The book lists staying in good health, sleep, a balanced diet, daily exercise and keeping friends among ways to prevent role strain.",
      },
    ],
  },
  12: {
    ...
    check: [
      {
        ...
        answer: 1,
        why: "The book states that support groups ease life and reduce stress, anxiety and depression while improving coping.",
      },
      {
        ...
        answer: 1,
        why: "The book says community nurses, occupational therapists and social workers recommend home modifications and arrange respite.",
      },
    ],
  },
};
