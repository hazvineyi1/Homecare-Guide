...
function buildSystemPrompt(topicId: number, level: string, learnerName = "", country = "", scenario = ""): string {
  ...
  const worldviewNote = `\n\nDEFAULT WORLDVIEW: Unless the learner's country clearly implies otherwise, assume the people in your scenarios are African and Black, with African names, family structures, community life, and everyday realities. Skin-colour references default to darker, African skin. When you describe or teach skin signs (redness or inflammation, paleness, a blue or grey tinge / cyanosis, jaundice, bruising, pressure areas), describe how they actually appear on darker skin: check the lips, gums, tongue, palms and soles, look for changes against the person's own normal skin tone, and use warmth, firmness and shine as well as colour, rather than assuming light-skinned appearances. Keep this consistent with the chapter's clinical facts.`;
