...
/**
 * @summary Start a new Socratic tutor session for a topic
 */
...
export const getSendTutorMessageUrl = (conversationId: number,) => {




  return `/api/tutor/sessions/${conversationId}/message`
}

/**
 * @summary Send a learner message in a tutor session (SSE stream response)
 */
export const sendTutorMessage = async (conversationId: number,
    tutorMessageInput: TutorMessageInput, options?: RequestInit): Promise<unknown> => {

  return customFetch<unknown>(getSendTutorMessageUrl(conversationId),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getSendTutorMessageMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof sendTutorMessage>>, TError,{conversationId: number;data: BodyType<TutorMessageInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof sendTutorMessage>>, TError,{conversationId: number;data: BodyType<TutorMessageInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof sendTutorMessage>>, {conversationId: number;data: BodyType<TutorMessageInput>}> = (props) => {
          const {conversationId,data} = props ?? {};

          return  sendTutorMessage(conversationId,data,requestOptions)
        }
...
export const useSendTutorMessage = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof sendTutorMessage>>, TError,{conversationId: number;data: BodyType<TutorMessageInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        {conversationId: number;data: BodyType<TutorMessageInput>},
        TContext
      > => {
      return useMutation(getSendTutorMessageMutationOptions(options));
    }

export const getGetTutorSessionUrl = (conversationId: number,) => {




  return `/api/tutor/sessions/${conversationId}`
}

/**
 * @summary Get a tutor session with full message history
 */
export const getTutorSession = async (conversationId: number, options?: RequestInit): Promise<TutorSessionWithMessages> => {

  return customFetch<TutorSessionWithMessages>(getGetTutorSessionUrl(conversationId),
  {
    ...options,
    method: 'GET'
...
export const getGetTutorSessionQueryKey = (conversationId: number,) => {
    return [
    `/api/tutor/sessions/${conversationId}`
    ] as const;
    }


export const getGetTutorSessionQueryOptions = <TData = Awaited<ReturnType<typeof getTutorSession>>, TError = ErrorType<AnthropicError>>(conversationId: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTutorSession>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetTutorSessionQueryKey(conversationId);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getTutorSession>>> = ({ signal }) => getTutorSession(conversationId, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: conversationId !== null && conversationId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getTutorSession>>, TError, TData> & { queryKey: QueryKey }
}

export type GetTutorSessionQueryResult = NonNullable<Awaited<ReturnType<typeof getTutorSession>>>
export type GetTutorSessionQueryError = ErrorType<AnthropicError>
...
export function useGetTutorSession<TData = Awaited<ReturnType<typeof getTutorSession>>, TError = ErrorType<AnthropicError>>(
 conversationId: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTutorSession>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetTutorSessionQueryOptions(conversationId,options)
